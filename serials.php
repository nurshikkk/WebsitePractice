    ...
    <div class="header">
        ...
        <div class="menubar">
            <ul class="menu">
                ...
                <li class="selected"><a href="serials.php">Serials</a></li>
    ...
    <div class="side-content">
        <div class="sidebar_container">
            ...
            <div class="sidebar">
                <h2>Ratings</h2>
                <ul>
                    <li><a href="show.php">Breaking Bad</a><span class="rating_sidebar">7.5</span></li>
                    <li><a href="show.php">Breaking Bad</a><span class="rating_sidebar">7.5</span></li>
                    <li><a href="show.php">Breaking Bad</a><span class="rating_sidebar">7.5</span></li>
                    <li><a href="show.php">Breaking Bad</a><span class="rating_sidebar">7.5</span></li>
                </ul>
        ...
        <div class="content">
            <div class="info_film">
                <img src="assets/images/breakingbad.png">
                ...
                <div class="button"><a href="show.php">Watch</a></div>
            </div>
            <div class="info_film">
                <img src="assets/images/silicon.png">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis augue in turpis ultrices cursus. Sed
                aliquam aliquet mi, nec auctor augue fringilla ut. Maecenas laoreet luctus mollis. Duis a sapien vitae
                nisl euismod tincidunt faucibus at velit. Cras ac feugiat leo, id tincidunt mauris. Donec ut turpis ut
                est elementum pulvinar in quis justo. Nulla facilisi. Donec ut sem at dui blandit fringilla ut ac justo.
            ...
            <div class="info_film">
                <img src="assets/images/xfiles.png">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis augue in turpis ultrices cursus. Sed
                aliquam aliquet mi, nec auctor augue fringilla ut. Maecenas laoreet luctus mollis. Duis a sapien vitae
                nisl euismod tincidunt faucibus at velit. Cras ac feugiat leo, id tincidunt mauris. Donec ut turpis ut
                est elementum pulvinar in quis justo. Nulla facilisi. Donec ut sem at dui blandit fringilla ut ac justo.
